...
Item{
    ...
    // Show it if it's on the intro screens
    visible:
    ...
    Row {
        ...
        Button {
            ...
            contentItem: Text {
                ...
                color: user_session_details_instance.page == "PageArticles.qml" ? instance_of_default_qml_class_values.defaultButtonSelectedColor : instance_of_default_qml_class_values.defaultButtonNotSelectedColor
                horizontalAlignment: Text.AlignHCenter
                verticalAlignment: Text.AlignVCenter
            }
        }
